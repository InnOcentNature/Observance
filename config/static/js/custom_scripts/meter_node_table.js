$(document).ready(function() {
    ...
    const table = $('#meter-node-table').DataTable({
        ajax: {
            type: "GET",
            url: "/load_meter_node_mappings",
            datatype: "json",
        ...
        columns: [
            {"data": "nodeId", "name": "nodeId", "autoWidth": true,"orderable": false},
            {"data": "meterNumber", "name": "meterNumber", "autoWidth": true,"orderable": false},
            ...
            {"data": "rfMeterType", "name": "rfMeterType", "autoWidth": true,"orderable": false},
            {"data": "meterMaker", "name": "meterMaker","orderable": false},
        ],
    });

    const custom_search_form = `<form class="m-auto w-auto float-md-right">
                                    <div class="input-group input-group-sm">
                                        <input type="text" name="search-box" class="form-control bg-light border-1 small" autocomplete="off" placeholder="Search by meter or node">
