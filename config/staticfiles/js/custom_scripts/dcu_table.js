$(document).ready(function() {
    const table_order_arr = [2, "desc"];
    const table_page_len = 10;

    const table = $('#dcu-table').DataTable({
            ajax: {
                url: "/load_dcus",
                type: "GET",
                datatype: "json",
            ...
            pageLength: table_page_len,
            language: {
            processing: 'Processing...',
            zeroRecords: "dcu not found",
    ...
    const custom_search_form = `<form class="m-auto w-auto float-md-right">
                                    <div class="input-group input-group-sm">
                                        <input type="text" name="search-box" class="form-control bg-light border-1 small" autocomplete="off" placeholder="Search by Gateway Id">
